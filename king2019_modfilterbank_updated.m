function [outsig, mfc, step] = king2019_modfilterbank_updated(insig,fs,kv,flags)
...
%     kv   : STRUCT with the following keys:
%       mflow       : minimum modulation centre frequency in Hz
%       mfhigh      : maximum modulation centre frequency in Hz
%       modbank_Nmod: Number of logarithmically-spaced (between fmin and fmax) 
%                     modulation filters (default N = 10)
%       modbank_Qfactor: Quality factor of the filters (default Qfactor = 1)
%     flags: STRUCT 
%
%   Output parameters:
